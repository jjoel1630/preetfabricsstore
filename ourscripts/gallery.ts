const gallerySwitcher = (evt, menuSection) => {
  ...
  var galleryContent = document.querySelectorAll<HTMLElement>(".gallery-content");
  ...
  var galleryLinks = document.querySelectorAll<HTMLElement>(".gallery-links");
  ...
  document.querySelector<HTMLElement>(`#${menuSection}`).style.display = "block";
...
document.querySelector<HTMLElement>("#defaultOpenGallery").click();